...
#define MS_UPDATE ((millis() - msUpdate) > msUpdatePeriod)
#define MS_UPDATE2 ((millis() - msUpdate) > (msUpdatePeriod * 2))
#define MS_PRINT ((millis() - msPrint) > msPrintPeriod)
#define MS_PRINT2 ((millis() - msPrint) > (msPrintPeriod * 2))
