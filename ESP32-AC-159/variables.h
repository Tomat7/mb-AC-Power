...
int16_t Pencoder = 0;
uint32_t msPrint = 0, msKeys = 0, msDisplay = 0, msPassed = 0;
uint32_t msInfoDuration = 0, msDispDuration, msTempDuration, msDuration1, msDuration4;
...
uint8_t showInfo = 0;
uint16_t msShowPeriod = SHOW_PERIOD;
