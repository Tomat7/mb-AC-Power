...
#else
#pragma message "OTA not configured! Nothing to compile. "
#endif //USE_OTA
...
/*
	...
	char const *ota_chars = ota_string.c_str();
	ArduinoOTA.setPassword(ota_string.c_str());
	ArduinoOTA.setPassword(ota_chars);
//	ArduinoOTA.setPassword(*ota_chars);
	ArduinoOTA.setPassword(String(WIFI_PASS + String(PLC_ID)).c_str());
*/
