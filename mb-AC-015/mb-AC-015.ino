#define PLC_ID 0x01
#define SKETCHVERSION "015"     // версия скетча (чтобы самому не запутаться :) new version DS lib
